...
extern int udp_receive_msg(int socket_fd, sockaddr_in * source, void * buffer, size_t msg_size);
extern int udp_send_msg(int socket_fd, sockaddr_in * destination, void * message, size_t msg_size);
