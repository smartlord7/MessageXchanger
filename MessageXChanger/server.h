...
#define CLIENT_IP_NOT_ALLOWED SERVER_UDP "-> [%s] IP NOT ALLOWED FOR SPECIFIED USER\n"
...
#define send_resp() udp_send_msg(clients_fd, &handshake->client_addr, (char *) &resp_msg, sizeof(response_msg_t))
